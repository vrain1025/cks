...
<div id="wrapper">
    ...
    <div id="main-content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                        <ul class="breadcrumb justify-content-end">
                            ...
                            <li class="breadcrumb-item active">成品入库</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <form action="cprk.php" method="post">
...
//采用 DISTINCT 去重查询结果
$sql = "SELECT DISTINCT *  FROM bcpk where code in (" . implode(',', $groupData) . ")";
     ...
     <div class="form-group">
         <label for="name" class="my-3">选择生产车间</label>
              ...
              <div class="input-group mb-3 my-3">
                ...
                <input type="text" class="form-control mx-3" placeholder="生产日期"  name="date" >
                ...
                <input type="text" class="form-control mx-3" placeholder="质检员"  name="zjy" >          
                             <div class="radio">
                  <label>
                    <input type="radio" name="yst" id="optionsRadios1" value="否" checked> 普通胎
                  </label>
                </div>
                <div class="radio">
                  <label>
                    <input type="radio" name="yst" id="optionsRadios2" value="是">演示胎
                  </label>
                </div>                                 
