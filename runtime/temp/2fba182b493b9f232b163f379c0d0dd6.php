<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:80:"/www/wwwroot/wms.langpailuntai.com/public/../apps/index/view/blpk/out_bound.html";i:1543220270;s:67:"/www/wwwroot/wms.langpailuntai.com/apps/index/view/common/head.html";i:1542949776;s:66:"/www/wwwroot/wms.langpailuntai.com/apps/index/view/common/top.html";i:1543222006;s:67:"/www/wwwroot/wms.langpailuntai.com/apps/index/view/common/left.html";i:1543202992;s:67:"/www/wwwroot/wms.langpailuntai.com/apps/index/view/common/menu.html";i:1543220274;s:67:"/www/wwwroot/wms.langpailuntai.com/apps/index/view/common/foot.html";i:1543220056;}*/ ?>
<!doctype html>
<html lang="en">
                    ...
                    <div class="card">
                        ...
                        <div id="main-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                                            <ul class="breadcrumb justify-content-end">
                                                ...
                                                <li class="breadcrumb-item active">不良品库存调拨</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$blpk): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    <td> <?php echo !empty($page)?($currentPage-1)*10+$i:$i; ?></td>
                                    <td><?php echo $blpk['ordernum']; ?> </td>
                                    <td><?php echo $blpk['model']; ?> </td>
                                    <?php if($blpk['tp'] != null): ?>
                                    <td><?php echo $blpk['code']; ?> </td>
                                    <td><?php echo $blpk['pd']; ?> </td>
                                    <?php endif; ?>
                                </tr>
                            ...
                            <form name="add" method="get" action="">
                                <div class="form-group ">
                                    <label for="jsck" >选择接收仓库</label>
                                    <select name="jsck" class="form-control col-4 ">
                                        <option value="">请选择仓库名称</option>
                                        <option value="mtk">不良品库</option>
                                        <option value="bcpk">半成品库</option>
                                        <option value="cpk">成品库</option>
                                        <option value="cpk">废品库</option>
                                    </select>
                                    <div class="input-group-prepend my-3">
                                     <span class="input-group-text">请输入入库日期</span>
                                      <input type="text" class="form-control col-3" placeholder="入库日期" name="rkdate">
                                     </div>
