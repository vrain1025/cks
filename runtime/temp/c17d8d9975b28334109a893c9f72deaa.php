<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:67:"E:\UPUPW_NP5.6\htdocs\cks2\public/../apps/index\view\cpk\query.html";i:1542939137;s:59:"E:\UPUPW_NP5.6\htdocs\cks2\apps\index\view\common\head.html";i:1542782131;s:58:"E:\UPUPW_NP5.6\htdocs\cks2\apps\index\view\common\top.html";i:1542078303;s:59:"E:\UPUPW_NP5.6\htdocs\cks2\apps\index\view\common\left.html";i:1542854027;s:59:"E:\UPUPW_NP5.6\htdocs\cks2\apps\index\view\common\foot.html";i:1542789380;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<title>:: 中橡狼牌轮胎 :: Home</title>
<meta charset="utf-8">
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li>
                        ...
                        <ul>                                    
                            ...
                            <li><a href="<?php echo url('index/fpk/wareHousing'); ?>">废品扫码出库</a></li>
                        </ul>
                    </li>                            
                </ul>
            </nav>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                                            <ul class="breadcrumb justify-content-end">
                                                ...
                                                <li class="breadcrumb-item active">成品信息查询</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <form action="" method="get">
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">请输入查询信息</span>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label class="fancy-radio">
                                                            <input name="gender" required="" type="radio" value="0" data-parsley-errors-container="#error-radio" data-parsley-multiple="gender" <?php if($yst == 0): ?> checked="checked"<?php endif; ?>>
                                                            <span><i></i>普通胎</span>
                                                        </label>
                                                        <label class="fancy-radio">
                                                            <input name="gender" type="radio" value="1" data-parsley-multiple="gender" <?php if($yst == 1): ?> checked="checked"<?php endif; ?>>
                                                            <span><i></i>演示胎</span>
                                                        </label>
                                                        <p id="error-radio"></p>
                                                    </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cpk): $mod = ($i % 2 );++$i;?>
                                     <tr>
                                        ...
                                        <td><?php echo $cpk['date']; ?> </td>
                                        <?php endif; ?>
                                        <td><?php echo $cpk['glue']; ?> </td>
                                        <?php switch($cpk['yst']): case "1": ?><td>是 </td><?php break; case "0": ?><td>否 </td><?php break; endswitch; ?>
                                    </tr>
