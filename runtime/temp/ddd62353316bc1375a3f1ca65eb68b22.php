<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"E:\UPUPW_NP5.6\htdocs\cks2\public/../apps/index\view\thk\ware_housing.html";i:1542770118;s:58:"E:\UPUPW_NP5.6\htdocs\cks2\apps\index\view\common\top.html";i:1542078303;s:59:"E:\UPUPW_NP5.6\htdocs\cks2\apps\index\view\common\left.html";i:1542770545;s:59:"E:\UPUPW_NP5.6\htdocs\cks2\apps\index\view\common\foot.html";i:1541492532;}*/ ?>
<!doctype html>
<html lang="en">
                        ...
                        <div id="main-content">
                            <div class="container-fluid">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-12">
                                        <form name="add" method="post" action="<?php echo url('wareHousingResult'); ?>" class="my-3">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">请输入入库日期</span>
                                                </div>
                                                <input type="text" class="form-control" placeholder="入库日期" name="rkdate">
                                                <div class="input-group-prepend ml-3 ">
                                                    <span class="input-group-text ">请输入原因</span>
                                                </div>
                                                <input type="text" class="form-control" placeholder="原因" name="reason">
                                                <input type="submit" name="submit" class="btn btn-primary " value="确认入库">
                                            </div>
                                        </form>
                                    </div>
