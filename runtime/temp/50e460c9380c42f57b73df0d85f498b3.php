<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:82:"/www/wwwroot/wms.langpailuntai.com/public/../apps/index/view/cpk/ware_housing.html";i:1543456308;s:67:"/www/wwwroot/wms.langpailuntai.com/apps/index/view/common/head.html";i:1542949776;s:66:"/www/wwwroot/wms.langpailuntai.com/apps/index/view/common/top.html";i:1543222006;s:67:"/www/wwwroot/wms.langpailuntai.com/apps/index/view/common/left.html";i:1543202992;s:67:"/www/wwwroot/wms.langpailuntai.com/apps/index/view/common/menu.html";i:1543220274;s:67:"/www/wwwroot/wms.langpailuntai.com/apps/index/view/common/foot.html";i:1544434077;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<title>:: 中橡狼牌轮胎 :: </title>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                                            <ul class="breadcrumb justify-content-end">
                                                ...
                                                <li class="breadcrumb-item active">成品批量查询</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-12">
                                        ...
                                        <table class="table table-hover text-center">
                                            ...
                                            <tr></tr>
                                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cpk): $mod = ($i % 2 );++$i;?>
                                            <tr>
                                                <td> <?php echo !empty($page)?($currentPage-1)*10+$i:$i; ?></td>
                                                <td><?php echo $cpk['id']; ?></td>
                                                <td><?php echo $cpk['ordernum']; ?> </td>
                                                <td><?php echo $cpk['model']; ?> </td>
                                                <td><?php echo $cpk['figure']; ?> </td>
                                                <td><?php echo $cpk['tp']; ?> </td>
                                                <?php if($cpk['tp'] != null): ?>
                                                <td><?php echo $cpk['code']; ?> </td>
                                                <td><?php echo $cpk['pd']; ?> </td>
                                                <?php endif; ?>
                                            </tr>
                                    ...
                                    <div class="col-12">
                                        <form name="add" method="get" action="<?php echo url('cpk/wareHousingResult'); ?>">
                                            <div class="form-group">
                                                ...
                                                <label for="bc" class="my-3">选择班次</label>
                                                <select name="bc" class="form-control">
                                                    <option value="A"> A班</option>
                                                    <option value="B"> B班</option>
                                                </select>
                                                <div class="input-group mb-3 my-3">
                                                    <input type="text" class="form-control" placeholder="入库单单号" name="rknum">
                                                    <input type="text" class="form-control mx-3" placeholder="请输入底胶型号" name="dglue">
                                                    <input type="text" class="form-control " placeholder="请输胶号" name="glue">
                                                    <div class="masked-input mx-3">
                                                    <input type="text" class="form-control date " placeholder="生产日期" name="date"></div>
                                                    <input type="text" class="form-control mx-3" placeholder="仓库管理员" name="ckgly">
                                                    <input type="text" class="form-control mx-3" placeholder="质检员" name="zjy">
                                                        
                                                        <label class="mx-3 my-2">轮胎类型</label>                                                       
                                                        <label class="fancy-radio custom-color-green mx-3 my-2">
                                                            <input name="gender" required="" type="radio" value="0" data-parsley-errors-container="#error-radio" data-parsley-multiple="gender" >
                                                            <span><i></i>普通胎</span>
                                                        </label>
                                                        <label class="fancy-radio custom-color-green mx-3 my-2">
                                                            <input name="gender" type="radio" value="1" data-parsley-multiple="gender">
                                                            <span><i></i>演示胎</span>
                                                        </label>
                                        ...
                                        <form method="post" action="export">
                                            <div class="col-2 my-3">
                                                <input type="submit" name="submit" class="btn btn-success active " value="导出到EXCEL">
                                            </div>
                                    </div>
                                    </form>
                                    <?php endif; ?>
