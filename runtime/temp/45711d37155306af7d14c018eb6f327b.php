<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"E:\UPUPW_NP5.6\htdocs\cks2\public/../apps/index\view\cpck\ware_housing.html";i:1542700885;s:58:"E:\UPUPW_NP5.6\htdocs\cks2\apps\index\view\common\top.html";i:1542078303;s:59:"E:\UPUPW_NP5.6\htdocs\cks2\apps\index\view\common\left.html";i:1542078607;s:59:"E:\UPUPW_NP5.6\htdocs\cks2\apps\index\view\common\foot.html";i:1541492532;}*/ ?>
<!doctype html>
<html lang="en">
...
<head>
    ...
    <meta name="description" content="中橡狼牌轮胎 Bootstrap 4.1.1 Admin Template">
                                    ...
                                    <div class="dropdown-menu animated flipInY user-profile">
                                        ...
                                        <div class="m-t-10 p-3 drop-list">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="divider"></li>
                                                <li><a href="<?php echo url('index/login/logout'); ?>"><i class="icon-power"></i>Logout</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
        ...
        <div class="sidebar-scroll">
           <nav id="leftsidebar-nav" class="sidebar-nav">
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="middle">
                        <a href="#uiElements" class="has-arrow"><i class="icon-diamond"></i><span>母胎库</span></a>
                        <ul>
                           ...
                           <li>
                        <a href="#forms" class="has-arrow"><i class="icon-pencil"></i><span>半成品库</span></a>
                        <ul>
                    ...
                    <li>
                        <a href="#forms" class="has-arrow"><i class="icon-pencil"></i><span>成品库</span></a>
                        <ul>
                    ...
                    <li>
                        <a href="#Tables" class="has-arrow"><i class="icon-tag"></i><span>成品出库</span></a>
                        <ul>
                    ...
                    <li>
                        <a href="#FileManager" class="has-arrow"><i class="icon-folder"></i><span>不良品库</span></a>
                        <ul>                                    
                            <li><a href="<?php echo url('index/fpk/index'); ?>">不良品统计</a></li>
                            <li><a href="<?php echo url('index/fpk/query'); ?>">不良品信息检索</a></li>
                            <li><a href="<?php echo url('index/fpk/batchQuery'); ?>">不良品条码批量查询</a></li>
                            <li><a href="<?php echo url('index/fpk/wareHousing'); ?>">不良品扫码入库</a></li>
                        </ul>
                    </li>  

                    <li>
                        <a href="#Widgets" class="has-arrow"><i class="icon-puzzle"></i><span>退货库</span></a>
                        <ul>                                    
                            ...
                            <li><a href="<?php echo url('index/thk/wareHousing'); ?>">退货扫码出库</a></li>
                        </ul>
                    </li>
                   
                    <li>
                        <a href="#FileManager" class="has-arrow"><i class="icon-folder"></i><span>废品库</span></a>
                        <ul>                                    
                                ...
                                <div class="row clearfix">
                                    <div class="col-12">
                                        ...
                                        <?php echo $list->render(); ?>
                                            <div class=" alert alert-success text-center col-2 pull-left">共<?php echo $count; ?>条数据</div>
                                    </div>
                                    
                                    <div class="col-4 clearfix"></div>
                                    <div class="col-12">
            <form name="add"  method="get" action="<?php echo url('cpck/wareHousingResult'); ?>" >
              <div class="form-group">
                  <label for="dls" class="my-3">选择收货单位</label>
                <select name="dls" class="form-control">
                <option value="北京市代理">客户自提</option>  
                <option value="北京市代理">中橡狼牌轮胎信阳公司</option>
                 <option value="北京市代理">中橡狼牌轮胎北京公司</option>
                <option value="北京市代理">北京市代理</option>
                <option value="天津市代理">天津市代理</option>
                <option value="河北省代理">河北省代理</option>
                <option value="山西省代理">山西省代理</option>
                <option value="内蒙古自治区">内蒙古自治区</option>
                <option value="辽宁省代理">辽宁省代理</option>
                <option value="吉林省代理">吉林省代理</option>
                <option value="黑龙江省代理">黑龙江省代理</option>
                <option value="上海市代理">上海市代理</option>
                <option value="江苏省代理">江苏省代理</option>
                <option value="浙江省代理">浙江省代理</option>
                <option value="安徽省代理">安徽省代理</option>
                <option value="福建省代理">福建省代理</option>
                <option value="江西省代理">江西省代理</option>
                <option value="山东省代理">山东省代理</option>
                <option value="河南省代理">河南省代理</option>
                <option value="湖北省代理">湖北省代理</option>
                <option value="湖南省代理">湖南省代理</option>
                <option value="广东省代理">广东省代理</option>
                <option value="广西壮族自治区">广西壮族自治区</option>
                <option value="海南省代理">海南省代理</option>
                <option value="重庆市代理">重庆市代理</option>
                <option value="四川省代理">四川省代理</option>
                <option value="贵州省代理">贵州省代理</option>
                <option value="云南省代理">云南省代理</option>
                <option value="西藏自治区">西藏自治区</option>
                <option value="陕西省代理">陕西省代理</option>
                <option value="甘肃省代理">甘肃省代理</option>
                <option value="青海省代理">青海省代理</option>
                <option value="宁夏回族自治区">宁夏回族自治区</option>
                <option value="新疆维吾尔自治区">新疆维吾尔自治区</option>                       
                </select>
              <div class="input-group mb-3 my-3">
                <input type="text" class="form-control" placeholder="请输入订单编号"  name="ddnum" >
                <input type="text" class="form-control mx-3" placeholder="请输入发货日期"  name="fhdate" > 
                <input type="text" class="form-control mx-3" placeholder="请输收货人姓名"  name="shname" >
                <input type="text" class="form-control" placeholder="请输入收货人电话"  name="shphone" >
                <input type="text" class="form-control mx-3" placeholder="请输入收货人地址"  name="shaddr" > 
                <input type="text" class="form-control" placeholder="请输入仓库管理员姓名"  name="fhgly" >
                <input type="submit" name="submit" class="btn btn-primary mx-3" value="确认出库">
              </div>
</div>
 </form></div>
                                    <div class="col-2 ">
...
<script src="/static//bundles/knob.bundle.js"></script> <!-- Jquery Knob-->
<script src="/static//bundles/flotscripts.bundle.js"></script> <!-- flot charts Plugin Js --> 
