<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:80:"/www/wwwroot/wms.langpailuntai.com/public/../apps/index/view/cpck/out_bound.html";i:1543456310;s:67:"/www/wwwroot/wms.langpailuntai.com/apps/index/view/common/head.html";i:1542949776;s:66:"/www/wwwroot/wms.langpailuntai.com/apps/index/view/common/top.html";i:1543222006;s:67:"/www/wwwroot/wms.langpailuntai.com/apps/index/view/common/left.html";i:1543202992;s:67:"/www/wwwroot/wms.langpailuntai.com/apps/index/view/common/menu.html";i:1543220274;s:67:"/www/wwwroot/wms.langpailuntai.com/apps/index/view/common/foot.html";i:1544434077;}*/ ?>
<!doctype html>
<html lang="en">
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane animated fadeIn" id="Timeline" aria-expanded="false">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                                            <ul class="breadcrumb justify-content-end">
                                                ...
                                                <li class="breadcrumb-item active">出库信息查询</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
              ...
              <div class="form-group">
                ...
                <select name="dls" class="form-control col-4">               
                <option value="">请选择代理商名称</option>
                <?php if(is_array($dls) || $dls instanceof \think\Collection || $dls instanceof \think\Paginator): $i = 0; $__LIST__ = $dls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dls): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo $dls['dls']; ?>"><?php echo $dls['dls']; ?></option>
              ...
              <div class="input-group mb-3 my-3">
                ...
                <input type="text" class="form-control" placeholder="请输入收货人电话"  name="shphone" {/if}>
                <input type="text" class="form-control mx-3" placeholder="请输入收货人地址"  name="shaddr" >               
                <input type="submit" name="submit" class="btn btn-primary mx-3" value="查询">
              </div>
</div>
 </form>
                                        </div>
                                ...
                                <table class="table table-hover">
                                            ...
                                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cpck): $mod = ($i % 2 );++$i;?>
                                            <tr>
                                                <td><?php echo $cpck['ddnum']; ?></td>
                                                <td><?php echo $cpck['dls']; ?> </td>
                                            <td> <?php echo !empty($page)?($currentPage-1)*10+$i:$i; ?></td>    
                                            
                                            <td><?php echo $cpck['ordernum']; ?> </td>
                                            <td><?php echo $cpck['model']; ?> </td>                                       
                                            <?php if($cpck['tp'] != null): ?>
                                            <td><?php echo $cpck['code']; ?> </td>
                                            <td><?php echo $cpck['pd']; ?> </td>
                                            <?php endif; ?>
                                            <td><?php echo $cpck['fhdate']; ?> </td>
                                            </tr>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </table>
