<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:68:"E:\UPUPW_NP5.6\htdocs\cks2\public/../apps/index\view\cpck\index.html";i:1543473600;s:58:"E:\UPUPW_NP5.6\htdocs\cks2\apps\index\view\common\top.html";i:1543222006;s:59:"E:\UPUPW_NP5.6\htdocs\cks2\apps\index\view\common\left.html";i:1551345721;s:59:"E:\UPUPW_NP5.6\htdocs\cks2\apps\index\view\common\menu.html";i:1543220274;s:59:"E:\UPUPW_NP5.6\htdocs\cks2\apps\index\view\common\foot.html";i:1544434077;}*/ ?>
<!doctype html>
<html lang="en">
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li>
                     ...
                     <li>
                        ...
                        <ul>                                    
                            <li><a href="<?php echo url('index/user/userlist'); ?>">用户管理</a></li>
                            <li><a href="<?php echo url('index/user/add'); ?>">添加用户</a></li>
                            <li><a href="<?php echo url('index/user/edit'); ?>">修改用户</a></li>                    
                        </ul>
                    </li>
                       <li>
                        <a href="#FileManager" class="has-arrow"><i class="icon-group"></i><span>用户组管理</span></a>
                        <ul>                              
                            <li><a href="<?php echo url('index/AuthGroup/userGrouplist'); ?>">用户组管理</a></li>
                            <li><a href="<?php echo url('index/AuthGroup/userGrouplist'); ?>">添加用户组</a></li>
                            <li><a href="<?php echo url('index/AuthGroup/userGrouplist'); ?>">用户组编辑</a></li>
                            <li><a href="<?php echo url('index/AuthGroup/authList'); ?>">用户权限管理</a></li>                          
                        </ul>
                    </li>                                           
                </ul>
            </nav>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 pull-right">
                                <form action="" method="post">
                                    <div class="form-group">
                                        <label>排序方式</label>
                                        <br>
                                        <label class="fancy-radio custom-color-red">
                                            <input name="px" required="" type="radio" value="" data-parsley-errors-container="#error-radio" data-parsley-multiple="gender" <?php if($px == ''): ?> checked="checked" <?php endif; ?>> <span><i></i>按商品编码排列</span>
                                        </label>
                                        <label class="fancy-radio custom-color-blue">
                                            <input name="px" type="radio" value="asc" data-parsley-multiple="gender" <?php if($px == 'asc'): ?> checked="checked" <?php endif; ?>> <span><i></i>按库存升序排列</span>
                                        </label>
                                        <label class="fancy-radio custom-color-green">
                                            <input name="px" type="radio" value="desc" data-parsley-multiple="gender" <?php if($px == 'desc'): ?> checked="checked" <?php endif; ?>> <span><i></i>按库存降序排列</span>
                                        </label>
