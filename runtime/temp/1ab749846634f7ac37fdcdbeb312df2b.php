            ...
            <div id="main-content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" method="Post" action="<?php echo url('addResult'); ?>">
                                <div class="form-group">
                                    <label>用户名</label>
                                ...
                                <div class="form-group">                        
                                 <div class="col-lg-6 col-md-12">
                                    <label>选择用户组</label><br/>
                                    
                                        <select name="groupid" class="multiselect multiselect-custom" id="single-selection" >
                                           <?php if(is_array($groupList) || $groupList instanceof \think\Collection || $groupList instanceof \think\Paginator): $i = 0; $__LIST__ = $groupList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
