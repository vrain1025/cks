                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li>
                     ...
                     <li>
                        ...
                        <ul>                                    
                            <li><a href="<?php echo url('index/AuthGroup/userlist'); ?>">用户管理</a></li>
