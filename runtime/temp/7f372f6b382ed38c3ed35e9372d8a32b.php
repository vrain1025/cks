                                    ...
                                    <div class="col-4 clearfix"></div>
                                        ...
                                        <form name="add" method="post" action="<?php echo url('wareHousingResult'); ?>" class="my-3"> 
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="请输入入库日期" name="rkdate">
