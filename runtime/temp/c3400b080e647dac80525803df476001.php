                                ...
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <ul class="header-dropdown">
                                            <li><a href="{usr/add}" data-toggle="modal" data-target="#addcontact"><i class="icon-plus"></i></a></li>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <p class="c_name"><?php echo $list['title']; ?></p>
                                                        </td>
                                                        <td>
