                                ...
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <ul class="header-dropdown">
                                            <li><a href="<?php echo url('user/add'); ?>" ><i class="icon-plus"></i></a></li>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <p class="c_name"><?php echo $list['username']; ?></p>
                                                        </td>
                                                        <td>
                                                            <?php switch($list['status']): case "1": ?><span class="badge badge-success">启用</span><?php break; case "0": ?><span class="badge badge-success">禁用</span><?php break; endswitch; ?>
                                                        </td>
                                                        <td>
                                                            <span><?php echo $list['group_id']; ?></span>
                                                        </td>
                                              <td>                                            
                                                <button title="编辑" class="btn btn-info" type="button"><i class="icon-edit"></i></button>
                                                <button title="删除" class="btn btn-danger js-sweetalert" type="button" data-type="confirm"><i class="icon-trash"></i></button>
                                            </td>  
                                                    </tr>
