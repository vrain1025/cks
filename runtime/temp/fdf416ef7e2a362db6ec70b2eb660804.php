                    ...
                    <div class="row clearfix">
                        ...
                        <div id="main-content">
                            <div class="container-fluid">
                                ...
                                <div class=" alert alert-success text-center col-4 pull-left"><strong>今天共入库<?php echo $count; ?>条轮胎&nbsp;&nbsp;<i class="icon-spinner icon-spin"></i> &nbsp;&nbsp;其中普通胎<?php echo $countnoyst; ?>条&nbsp;&nbsp;<i class="icon-spinner icon-spin"></i>&nbsp;&nbsp; 演示胎<?php echo $countyst; ?>条</strong></div>
                            </div>
                        </div>
                        <!-- Javascript -->
