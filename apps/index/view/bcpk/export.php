...
$sheet->setTitle('查询结果');
//设置表头
$sheet->setCellValueByColumnAndRow(1, 1, '查询结果');
...
$spreadsheet->getActiveSheet()->getDefaultColumnDimension()->setWidth(20);
 ...
 $result=array_pop($groupData);
    ...
    $sql = "SELECT id,ordernum,model,figure,tp,code,pd FROM bcpk where code in (" . implode(',', $groupData) . ")";    
    ...
    $total_rows = $len + 2;
    //添加所有边框/居中
    $sheet->getStyle('A1:G'.$total_rows)->applyFromArray($styleArrayBody);
