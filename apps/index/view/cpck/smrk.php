...
<div id="wrapper">
    ...
    <div id="main-content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                        <ul class="breadcrumb justify-content-end">
                            ...
                            <li class="breadcrumb-item active">出库商品批量入库</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <form action="mcds.php" method="post">
            <div class="row align-items-center justify-content-center">
                <h2>狼牌轮胎条码出库商品扫码入库</h2>
            </div>
...
//采用 DISTINCT 去重查询结果
$sql = "SELECT DISTINCT *  FROM cpck where code in (" . implode(',', $groupData) . ")";
