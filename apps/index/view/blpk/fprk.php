...
<div id="wrapper">
    ...
    <div id="main-content">
                ...
                <div class="row">                          
                    <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                        <ul class="breadcrumb justify-content-end">
                            ...
                            <li class="breadcrumb-item active">不良品入库</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <form action="smrk.php" method="post">
...
//采用 DISTINCT 去重查询结果
$sql = "SELECT DISTINCT *  FROM basic where code in (" . implode(',', $groupData) . ")";
...
<form method="post" action="export.php">
  ...
  <div>  <form name="add" method="post" action="add.php" >
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control mx-3" placeholder="请输入报废原因"  name="reason" >                             
